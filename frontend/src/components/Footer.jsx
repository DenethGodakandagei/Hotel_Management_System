...
export const Footer = () => {
  return (
    <div>
        <footer className=" bottom-0 left-0 z-40 w-full p-4 bg-gray-300   shadow md:flex md:items-center md:justify-between md:p-6 bg-gradient-to-r from-orange-500 to-blue-500  dark:border-gray-600">
